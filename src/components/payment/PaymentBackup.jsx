...
function Payment() {
  ...
  const checkParams = () => {
    ...
    if (!checkP) {
      ...
      const encryptedToken = checkP.token;
      const info2x = CryptoJS.AES.decrypt(encryptedToken, "U2FsdGVkX1+RFxINtDchhPqAxYecNts3Di1tTgbwHg0=").toString(CryptoJS.enc.Utf8);
    ...
    //     const info2x = CryptoJS.AES.decrypt(checkP.token, "U2FsdGVkX1+RFxINtDchhPqAxYecNts3Di1tTgbwHg0=").toString(
    //       CryptoJS.enc.Utf8
    //     );
