...
function PaymentBonn() {
  ...
  const checkParams = () => {
    ...
    if (!checkP) {
      ...
      // let info2x = CryptoJS.AES.decrypt(atob(checkP.token), process.env.REACT_APP_SECRET_KEY).toString(CryptoJS.enc.Utf8);
