...
import InputCheckboxComponent from "../../atoms/InputCheckboxComponent.jsx";
...
function SectionMobile() {
                        ...
                        getOthersById
                            ...
                            .forEach(othersComponent => {
                                ...
                                dynamicValidationSchema[`others_${othersComponent.id}`] = Yup.string().required(
                                    `Others ${othersComponent.others_column} Wajib Diisi`
                                );
                            });
                    })
    ...
    }, [getDataSectionById, getDataSubSectionId, getProductById, getOthersById, getProductBySectionId, getComponent])
