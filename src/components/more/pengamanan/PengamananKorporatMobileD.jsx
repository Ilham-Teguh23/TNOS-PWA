...
function PengamananKorporatMobile() {
  ...
  const formik = useFormik({
    ...
    initialValues: {
      ...
      user_id: userData === null ? 9999999999 : userData.mmbr_code,
      name: userData === null ? "GUEST" : userData.mmbr_name,
      email: userData === null ? "guest@gmail.com" : userData.mmbr_email,
      phone: userData === null ? "085323949111" : userData.mmbr_phone,
      nomor_pic: "",
      // needs: "",
      // nama: "",
      nama_pic: "",
